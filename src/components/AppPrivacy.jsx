    ...
    return (
        <div className="max-w-5xl mx-auto py-12 px-6">
            <div className="mb-16 text-center relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-blue-500/20 blur-[80px] rounded-full z-0 pointer-events-none"></div>
                <div className="inline-block p-4 bg-white/50 backdrop-blur-xl rounded-[2rem] shadow-lg shadow-blue-500/20 mb-6 border border-white/60 relative z-10">
                    <Shield size={48} className="text-blue-600" strokeWidth={1.5} />
                </div>
            ...
            <div className="bg-white/60 backdrop-blur-xl rounded-[3rem] p-8 md:p-12 border border-white/60 shadow-xl shadow-slate-200/50 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-100/50 rounded-full blur-[100px] -mr-20 -mt-20 pointer-events-none"></div>
                ...
                <div className="space-y-12 text-slate-600 leading-relaxed relative z-10">
                    ...
                    <section className="bg-slate-50/80 backdrop-blur rounded-[2rem] p-8 border border-slate-100">
                        ...
                        <a href="mailto:support@travelcfo.app" className="inline-flex items-center gap-2 text-blue-600 font-bold hover:underline text-xl">
